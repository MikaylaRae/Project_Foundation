...
def edit_profile(id): 
    ...
    return render_template("edit.html",edit = Profile.get_one(data), user=User.get_by_id(user_data))
...
def show_profile(id): 
    ...
    return render_template("show_profile.html",  user = User.get_by_id(user_data), profile = Profile.get_one(profile_data))
